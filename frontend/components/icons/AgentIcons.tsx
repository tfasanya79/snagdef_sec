...
export const CpuChipIcon: React.FC<{className?: string}> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M18.75 8.25A6.75 6.75 0 0012 4.5a6.75 6.75 0 00-6.75 3.75m13.5 0A6.75 6.75 0 0112 19.5a6.75 6.75 0 01-6.75-3.75m13.5 0H12m6.75 0H12" />
  </svg>
);
